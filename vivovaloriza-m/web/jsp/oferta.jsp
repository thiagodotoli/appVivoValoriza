...
<body>
   ...
   <!-- HEADER -->
      <div data-role="header" data-fullscreen="true">
         <div id="headerBox">
           <a href="listarEspetaculosDesconto.action" class="back"><span class="iconVoltar" ></span><h2>Voltar</h2></a>
         </div>
      </div>
      <!-- /header -->
      ...
      <div data-role="content">
         ...
         <ul data-role="listview" data-inset="true">
            <li class="oferta-item" data-theme="">
               <a class="oferta-link-espetaculo" href="exibirVoucherEspetaculoDesconto.action?cnSeq=<s:property value='cnSeq'/>">
                  <div class="oferta-data">
                     ...
                     <p class="oferta-descr">
                        <s:property value='anDesc'/>   
                        <span class="laranja right solicitar">&raquo; solicitar voucher</span>
                     </p>
                  </div>
               </a>
            </li>
