...
public class ParceiroFiltrarAction {
	
	List<DominioVO> categorias;

	public ParceiroFiltrarAction() {
	}
    ...
    public String execute() {
		...
		if(SOAP_URL.equals("LOCAL")) {
			xml = "<"+actionName+"Response><itens>" +
					"<item><caDom>BR</caDom><anDescr>Bares / Restaurantes</anDescr><anVar1></anVar1><anVar2></anVar2><nmVar1></nmVar1><nmVar2></nmVar2><dtVar1></dtVar1><dtVar2></dtVar2></item>" +
					"<item><caDom>CP</caDom><anDescr>Compras</anDescr><anVar1></anVar1><anVar2></anVar2><nmVar1></nmVar1><nmVar2></nmVar2><dtVar1></dtVar1><dtVar2></dtVar2></item>" +
